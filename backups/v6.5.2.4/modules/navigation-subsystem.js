...
export class NavigationSubsystem {
    constructor(logger, uiManager, settingsManager) {
        ...
        // Navigation state
        this.currentView = 'import'; // Default view
    ...
    async navigateToView(view, options = {}) {
        try {
            ...
            if (!this.isValidView(view)) {
                const errorContext = {
                    component: 'NavigationSubsystem',
                    operation: 'navigateToView',
                    requestedView: view,
    ...
    updatePageTitle(view) {
        ...
        const baseTitle = 'PingOne User Import v6.0';
     ...
     */
    getValidViews() {
        return ['home', 'import', 'export', 'modify', 'delete-csv', 'settings', 'logs', 'history'];
    }
