...
async function fetchDefaultPopulation(environmentId, clientId, clientSecret, region = 'NorthAmerica') {
    try {
        ...
        const tokenUrl = `https://${authDomain}/as/token.oauth2`;
 ...
 *       
 *       ## Security Note
 *       - This endpoint returns the plain text API secret for display purposes
 *       - The secret is only decrypted for display and not stored in plain text
 *       - Ensure proper access controls are in place for this endpoint
 *       
 *       ## Storage
